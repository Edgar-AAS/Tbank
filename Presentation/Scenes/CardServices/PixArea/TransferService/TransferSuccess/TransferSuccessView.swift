...
public final class TransferSuccessView: UIView {
    ...
    private lazy var transferDateLabel: UILabel = {
        let view = UILabel()
        view.textAlignment = .center
        view.textColor = UIColor(hexString: "#cecece")
    ...
    private lazy var contentStack = makeVerticalStack(with: [balanceLabel, transferDateLabel, recipientName, sendReceiptButton], spacing: 8)
}
